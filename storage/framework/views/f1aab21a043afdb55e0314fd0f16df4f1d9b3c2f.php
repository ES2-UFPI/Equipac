      ...
      <div class="card-body table-responsive p-0">
        <table class="table table-hover">
          ...
          <tr>
            ...
            <th>
              <form method="post" action="<?php echo e(route('manutencao.store')); ?>">
               <?php echo csrf_field(); ?>

               <input type="hidden" name="id" value="<?php echo e($ma['id']); ?>">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\DESENVOLVIMENTO\COMPUTACAO\Equipac\resources\views/usuarios/manutencao.blade.php ENDPATH**/ ?>